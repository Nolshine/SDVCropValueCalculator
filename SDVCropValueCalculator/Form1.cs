        ...
        private string DetermineCrop(string seasonToCheck, int mod)
        {
            ...
            foreach (string[] row in cropData)
            {
                ...
                if (daysToGrow > daysLeftInSeason)
                {
                    ...
                    // and also if the crop we can't grow is sweet gem,
                    // get rid of the commentLabel text
                    if (currentCrop == "Sweet Gem Berry*")
                    {
                        commentLabel.Text = "";
                    }
                ...
                if (resultList.Count > 3)
                {
                    ...
                    if (resultList[3] == numberPlayerCanBuy + " Sweet Gem Berry* for " +
                        profitPerDay + "G per day.")
                    {
                        commentLabel.Text = "";
                    }
